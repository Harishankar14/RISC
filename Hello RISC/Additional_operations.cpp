...
void test_arithmetic(float x,float y){
    Posit8 a=Posit8::fromFloat(x);
    Posit8 b=Posit8::fromFloat(y);

    float sum_posit=(a+b).toFloat();
    float sum_float=x+y;


    float mul_posit=(a*b).toFloat();
    float mul_float=x*y;
    std::cout << "x = " << x << ", y = " << y << "\n";
    std::cout << "Sum (Posit): " << sum_posit << ", Sum (Float): " << sum_float << "\n";
    std::cout << "Mul (Posit): " << mul_posit << ", Mul (Float): " << mul_float << "\n\n";
...
int main() {
    ...
    test(-1.0f);
    test(NAN);
    test_arithmetic(1.0f, 0.5f);
    test_arithmetic(2.0f, -1.5f);
    test_arithmetic(0.25f, 0.25f);
